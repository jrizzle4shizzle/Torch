                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="sitePermissions"><g:message code="eventType.sitePermissions.label" default="Site Permissions" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: eventTypeInstance, field: 'sitePermissions', 'errors')}">
