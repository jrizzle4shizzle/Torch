...
class PositionTypeController {
    ...
    def list = {
        ...
        [positionInstanceList: PositionType.list(params), positionInstanceTotal: PositionType.count()]
    }
    ...
    def create = {
        ...
        def positionInstance = new PositionType()
    ...
    def save = {
        ...
        def positionInstance = new PositionType(params)
    ...
    def show = {
        def positionInstance = PositionType.get(params.id)
        if (!positionInstance) {
